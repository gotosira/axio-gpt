...
export function AssistantWelcome({ assistantId, onSuggestionClick }: AssistantWelcomeProps) {
  const assistants = {
    ...
    'asst_4nCaYlt7AA5Ro4pseDCTbKHO': { // FlowFlow
      ...
      description: 'เราเกิดมาเพื่อช่วยดีไซน์ UX/UI ให้ปัง สวย และตรงมาตรฐานของ AXONS! ไม่ว่าจะเป็น Web หรือ Mobile เราพร้อมแนะนำให้ใช้งานได้ลื่นทุกแพลตฟอร์มเลย 💻📱 เราจะวิเคราะห์และใช้ความรู้ทั้งหมดของเราในการออกแบบก่อนสร้าง Mockup และ UI Concept ที่เหมาะสมให้คุณ!',
      suggestions: [
        'สร้างรูป Mockup สำหรับ Mobile App',
        'ช่วยออกแบบ UI Concept สำหรับ Website',
        'ร่าง Wireframe สำหรับ Dashboard',
        'สร้างภาพ Prototype สำหรับ E-commerce'
      ]
    }
  };
