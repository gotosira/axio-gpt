...
export function AssistantWelcome({ assistantId, onSuggestionClick }: AssistantWelcomeProps) {
  const assistants = {
    ...
    'asst_4nCaYlt7AA5Ro4pseDCTbKHO': { // FlowFlow
      ...
      description: 'เราเกิดมาเพื่อช่วยดีไซน์ UX/UI ให้ปัง สวย และตรงมาตรฐานของ AXONS! ไม่ว่าจะเป็น Web หรือ Mobile เราพร้อมแนะนำให้ใช้งานได้ลื่นทุกแพลตฟอร์มเลย 💻📱 พร้อมสร้างภาพ Mockup และ UI Concept ให้คุณด้วย!',
      suggestions: [
